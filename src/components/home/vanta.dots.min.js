  ...
  return (function (t) {
    ...
    8: function (t, e, i) {
      ...
      class r extends s.b {
        ...
        onInit() {
          var t = (this.camera = new n.PerspectiveCamera(
            50,
          ...
          var e,
            ...
            a,
            c,
            u = (this.starsGeometry = new n.Geometry()),
            l = this.options.spacing;
          for (e = s = -30; s <= 30; e = ++s)
            for (i = r = -30; r <= 30; i = ++r)
              ((h = new n.Vector3()).x = e * l + l / 2),
                (h.y = Object(o.h)(0, 5) - 150),
                (h.z = i * l + l / 2),
                u.vertices.push(h);
          if (
            ...
            (c = this.starField = new n.Points(u, a)),
            this.scene.add(c),
            this.options.showLines)
          ) {
            var d = new n.LineBasicMaterial({ color: this.options.color2 }),
              p = new n.Geometry();
            for (e = 0; e < 200; e++) {
              var f = Object(o.h)(40, 60),
                ...
                y = Math.sin(v) * g,
                M = Math.cos(v) * g;
              p.vertices.push(new n.Vector3(M * f, y * f, w * f)),
                p.vertices.push(new n.Vector3(M * m, y * m, w * m));
            }
            (this.linesMesh = new n.LineSegments(p, d)),
